    ...
    <div style={{
      ...
      <div ref={contentRef} style={{
        ...
        {viewMode === "single" ? (
          <div>
            <div style={{
              textAlign: "center", marginBottom: 32, fontFamily: "'Trebuchet MS', sans-serif",
            ...
            <p style={{
              fontSize: 15, color: COLORS.textLight, fontFamily: "'Trebuchet MS', sans-serif", marginBottom: 16,
            ...
            <div style={{
              ...
              <button onClick={goPrev} disabled={currentIndex === 0} style={{
                ...
                fontSize: 17, fontFamily: "'Trebuchet MS', sans-serif",
          ...
          <div>
            {entries.map((e, i) => (
              <div key={e.id} style={{
                ...
                <p style={{
                  fontSize: 14, color: COLORS.textLight, fontFamily: "'Trebuchet MS', sans-serif", marginBottom: 14,
                }}>{formatDate(e.date)}</p>
                {e.response.split("\n\n").map((paragraph, j) => (
